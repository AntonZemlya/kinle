                        ...
                        <div class="sidebar__widget gray-bg">
                            ...
                            <ul class="sidebar__menu-collapse">
                                ...
                                <li class="sidebar__menu-collapse-list">
                                    <div class="accordion">
                                        <a href="#" class="accordion__title" data-toggle="collapse" data-target="#men-fashion">Men <i class="icon-chevron-down"></i></a>
                                ...
                                <li class="sidebar__menu-collapse-list">
                                    <div class="accordion">
                                        <a href="#" class="accordion__title" data-toggle="collapse" data-target="#women-fashion">Women <i class="icon-chevron-down"></i></a>

                                        <div id="women-fashion" class="collapse">
                                            <ul class="accordion__category-list">
                                                <li><a href="#">Dresses</a></li>
                                                <li><a href="#">Jackets &amp; Coats</a></li>
                                                <li><a href="#">Sweaters</a></li>
                                ...
                                <li class="sidebar__menu-collapse-list">
                                    <div class="accordion">
                                        <a href="#" class="accordion__title" data-toggle="collapse" data-target="#kids-fashion">Kids <i class="icon-chevron-down"></i></a>

                                        <div id="kids-fashion" class="collapse">
                                            <ul class="accordion__category-list">
                                                <li><a href="#">Dresses</a></li>
                                                <li><a href="#">Jackets &amp; Coats</a></li>
                                                <li><a href="#">Sweaters</a></li>
                                ...
                                <div class="col-12">
                                    <div class="banner__box">
                                        <a href="single-1.html" class="banner__link">
                                            <img src="assets/img/banner/banner-shop-1-img-2.jpg"  alt="" class="banner__img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content ">
                            <div class="tab-pane show active clearfix" id="sort-grid">
                                ...
                                <div class="product__box product__box--default product__box--border-hover text-center float-left float-3">
                                    ...
                                    <a href="{{ $product['virtual_name'] }}" class="product__link product__link--underline product__link--weight-light m-t-15">
                                        {{ $product['name'] }}
                                    </a>
