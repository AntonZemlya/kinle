...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/plugin/plugins.min.css') }}"/>
                        ...
                        <div class="col-12">
                            <div class="header__top-content">
                                ...
                                <div class="header__top-content--right">
                                    ...
                                    <div class="user-info user-set-role">
                                        <a class="user-set-role__button" href="#" data-toggle="dropdown" aria-haspopup="true"> <img src="{{ asset('assets/img/icon/flag/icon_usa.png') }}" alt="">USA <i class="fal fa-chevron-down"></i></a>
                                        <ul class="expand-dropdown-menu dropdown-menu">
                                            <li><a href="#"><img src="{{ asset('assets/img/icon/flag/icon_usa.png') }}" alt="">English</a></li>
                                            <li><a href="#"><img src="{{ asset('assets/img/icon/flag/icon_france.png') }}" alt=""> Français</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="header__logo">
                                <a href="index.html" class="header__logo-link">
                                    <img src="{{ asset('assets/img/logo/logo-color.jpg') }}" alt="" class="header__logo-img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                    ...
                    <div class="row col-12">
                        <nav>
                            <ul class="header__nav">
                                <a href="/product" class="header__nav-link">Product <i class="icon-chevron-down"></i></a>
                                ...
                                <!--Start Single Nav link-->
                                <li class="header__nav-item pos-relative">
                                    <a href="#" class="header__nav-link">Страницы <i class="icon-chevron-down"></i></a>
                                    <!--Single Dropdown Menu-->
                                    <ul class="dropdown__menu pos-absolute">
                                    ...
                                    <ul class="mega-menu pos-absolute">
                                        ...
                                        <li class="mega-menu__banner">
                                            <a href="shop-1.html" class="mega-menu__banner-link">
                                                <img src="{{ asset('assets/img/banner/menu-banner.jpg') }}" alt="" class="mega-menu__banner-img">
                                            </a>
                                        </li>
                                        <!--Megamenu Item Banner-->
                                    </ul>
                        ...
                        <div class="header__mobile-top">
                            <div class="mobile-header__logo">
                                <a href="index.html" class="mobile-header__logo-link">
                                    <img src="{{ asset('assets/img/logo/logo-color.jpg') }}" alt="" class="mobile-header__logo-img">
                                </a>
                            </div>
                            <div class="header__wishlist-box">
                                <!-- Start Header Wishlist Box -->
                                <div class="header__wisishlist-item-count pos-absolute">3</span>
                                    </a>
                                </div> <!-- End Header Wishlist Box -->
            ...
            <div class="offcanvas-inner">
                <div class="offcanvas-userpanel m-b-30">
                    <ul>
                        ...
                        <li class="offcanvas-userpanel__role">
                            <a href="#"><img src="{{ asset('assets/img/icon/flag/icon_usa.png') }}" alt="">English </a>
                            <ul class="user-sub-menu">
                                <li><a href="#"><img src="{{ asset('assets/img/icon/flag/icon_usa.png') }}" alt="">English</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/icon/flag/icon_france.png') }}" alt=""> Français</a></li>
                            </ul>
            ...
            <ul class="offcanvas-add-cart__menu">
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img src="{{ asset('assets/img/product/size-small/product-home-1-img-1.jpg') }}" alt="" class="add-cart__img"></a>
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img src="{{ asset('assets/img/product/size-small/product-home-1-img-2.jpg') }}" alt="" class="add-cart__img"></a>
            ...
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-lg-3 col-xl-3">
                    ...
                    <div class="header-menu-vertical d-lg-block d-none">
                        <h4 class="menu-title link--icon-left"><i class="far fa-align-left"></i> All Cattegories</h4>
                        <ul class="menu-content">
                            <li class="menu-item">
                                <a href="#">Electronics <i class="icon-chevron-right"></i></a>
                            ...
                            <li class="menu-item">
                                <a href="#">Video Games <i class="icon-chevron-right"></i></a>
                            ...
                            <li class="menu-item" style="display: none;"><a href="#"> Smart Home Appliances</a></li>
                        </ul>
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-1.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-2.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-3.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-4.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-5.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-6.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-7.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-8.jpg') }}" alt="">
                                                        </a>
...
SonicFuel Wireless Over-Ear Headphones
                                                ...
                                                <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                                    <div class="product__img-box">
                                                        <a href="single-1.html" class="product__img--link">
                                                            <img class="product__img" src="{{ asset('assets/img/product/size-large/product-home-1-lg-img-1.jpg') }}" alt="">
                                                        </a>
                                                ...
                                                <div class="product__box product__box--segment  swiper-slide">
                                                    <div class="row">
                                                        <div class="col-xl-5 col-lg-12">
                                                            <div class="product__img-box">
                                                            <a href="single-1.html" class="product__img--link">
                                                                <img class="product__img" src="{{ asset('assets/img/product/size-normal/product-home-1-img-9.jpg') }}" alt="">
                                                            </a>
                                                        </div>
                                                        </div>
                                                        <div class="col-xl-7 col-lg-12">
...
SonicFuel Wireless Over-Ear Headphones
                                    ...
                                    <div class="blog-news blog-news-1grid overflow-hidden  m-t-50">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="blog-news__box swiper-slide text-center">
                                                <div class="blog-news__img-box">
                                                    <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                        <img src="{{ asset('assets/img/blog/news/blog-news-home-1-img-1.jpg') }}" alt="" class="blog-news__img">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="blog-news__box swiper-slide text-center">
                                                <div class="blog-news__img-box">
                                                    <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                        <img src="{{ asset('assets/img/blog/news/blog-news-home-1-img-2.jpg') }}" alt="" class="blog-news__img">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="blog-news__box swiper-slide text-center">
                                                <div class="blog-news__img-box">
                                                    <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                        <img src="{{ asset('assets/img/blog/news/blog-news-home-1-img-3.jpg') }}" alt="" class="blog-news__img">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="blog-news__box swiper-slide text-center">
                                                <div class="blog-news__img-box">
                                                    <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                        <img src="{{ asset('assets/img/blog/news/blog-news-home-1-img-4.jpg') }}" alt="" class="blog-news__img">
                                                    </a>
                                                </div>
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="hero hero-slider hero---2">
                        <div class="swiper-wrapper">
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url({{ asset('assets/img/hero/hero-home-2-img-1.jpg') }});">
                            ...
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2  swiper-slide" style="background-image: url({{ asset('assets/img/hero/hero-home-2-img-2.jpg') }});">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            ...
                                            <a href="single-1.html" class="btn btn--box btn--border btn--large btn--uppercase btn--weight">Shopping Now</a>
                                        </div>
                                    </div>
                                </div> <!-- End Hero Image -->
                            </div>
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url({{ asset('assets/img/hero/hero-home-2-img-3.jpg') }});">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                            ...
                            <div class="col-12">
                                <div class="banner__box">
                                    <a href="single-1.html" class="banner__link">
                                        <img src="{{ asset('assets/img/banner/banner-home-4-img-1.jpg') }}" alt="" class="banner__img">
                                    </a>
                                </div>
                            </div>
                        </div>
...
SonicFuel Wireless Over-Ear Headphones
                    ...
                    <div class="banner banner--1">
                        <div class="row">
                            <div class="col-12">
                                <div class="banner__box">
                                    <a href="single-1.html" class="banner__link">
                                        <img src="{{ asset('assets/img/banner/banner-home-4-img-2.jpg') }}" alt="" class="banner__img">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-12">
                                ...
                                <div class="cms__content">
                                    <div class="cms__icon">
                                        <img class="cms__icon-img" src="{{ asset('assets/img/icon/cms/icon1.png') }}" alt="">
                                    </div>
                                    <div class="cms__text">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="cms__content">
                                    <div class="cms__icon">
                                        <img class="cms__icon-img" src="{{ asset('assets/img/icon/cms/icon2.png') }}" alt="">
                                    </div>
                                    <div class="cms__text">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="cms__content">
                                    <div class="cms__icon">
                                        <img class="cms__icon-img" src="{{ asset('assets/img/icon/cms/icon3.png') }}" alt="">
                                    </div>
                                    <div class="cms__text">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="cms__content">
                                    <div class="cms__icon">
                                        <img class="cms__icon-img" src="{{ asset('assets/img/icon/cms/icon4.png') }}" alt="">
                                    </div>
                                    <div class="cms__text">
                        ...
                        <div class="footer__about">
                            <div class="footer__logo">
                                <a href="index.html" class="footer__logo-link">
                                    <img src="{{ asset('assets/img/logo/logo-color.jpg') }}" alt="" class="footer__logo-img">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="footer__payment">
                            <a href="https://hasthemes.com/" class="footer__payment-link">
                                <img src="{{ asset('assets/img/company-logo/payment.png') }}" alt="" class="footer__payment-img">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="modal__product-img">
                                        <img class="img-fluid" src="{{ asset('assets/img/product/size-normal/product-home-1-img-1.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    <script src="{{ asset('assets/js/plugin/plugins.min.js') }}"></script> -->
